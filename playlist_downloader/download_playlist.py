...
from transcribe_script import main as transcribe_video  # Correct import path
        ...
        try:
            ...
            for entry in info_dict['entries']:
                ...
                try:
                    ...
                    # Debug statement to check if transcription should run
                    if transcribe:
                        print(f"Transcription is enabled. Running transcription on: {video_path}")
                        transcribe_video(video_path)
                        print(f"Transcribed {video_path}")
                    else:
                        print("Transcription is disabled. Skipping transcription.")
